...
import {faBell, faSearch, faShoppingBasket, faShoppingCart, faUserPlus,faSortDown} from "@fortawesome/free-solid-svg-icons";
import './header.css';
...
const Header = () => {
  ...
  Get Membership
  <FontAwesomeIcon icon={faUserPlus}  className="ml-3" style={{color:"blue"}} />

  </button>
  <button className="upgrade" >
  Upgrade
  <FontAwesomeIcon icon={faShoppingCart} className="ml-1"style={{color:"grey"}} />
